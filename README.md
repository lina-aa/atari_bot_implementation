...
1. v1 - basic bot version; learned only to jump over bombs (200 000 iterations)
2. v2 - bot with a early custom wrapper that gave additional reward for getting higher; only stood in the corner, didn't do much (200 000 iterations)
3. v3 - bot with upgraded wrapper; learned to use magicbombs to jump higher (200 000 iterations + 2 000 000 additional iterations)
